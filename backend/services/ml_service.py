...
class MLService:
    ...
    def analyze_emotions(self, text: str) -> Dict:
        ...
        aggression_score = emotion_dict.get("anger", 0.0)
    ...
    def detect_cognitive_biases(self, text: str) -> List[Dict]:
        ...
        overgeneralization_patterns = [
            ...
            r'\bevery time\b', r'\ball the time\b'
        ]
        ...
        mind_reading_patterns = [
            r'\byou think\b', r'\byou believe\b', r'\byou want to\b',
            r'\byou\'re trying to\b', r'\byou just want\b'
        ]
        ...
        catastrophizing_patterns = [
            r'\bruined\b', r'\bdestroyed\b', r'\bterrible\b', r'\bawful\b',
        ...
        gaslighting_patterns = [
            r'\byou\'re overreacting\b', r'\byou\'re too sensitive\b',
            r'\bthat never happened\b', r'\byou\'re imagining things\b',
            r'\byou\'re crazy\b'
        ]
